...
class _CalendarWidgetState extends State<CalendarWidget> {
  ...
  void initState() {
    super.initState();
    _displayMonth = DateTime(widget.selectedDate.year, widget.selectedDate.month, 1);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: 210, // Increased height to accommodate month header with arrows
  ...
  Widget _buildCalendarGrid(BuildContext context) {
    ...
    DateTime firstDayOfDisplayMonth = DateTime(_displayMonth.year, _displayMonth.month, 1);
    
    // Find the starting day of the week for the first day of the month
    int startDayOfWeek = firstDayOfDisplayMonth.weekday % 7; // Sunday is 0, Monday is 1, etc.
    ...
    for (int i = 0; i < DateTime(_displayMonth.year, _displayMonth.month + 1, 0).day; i++) {
      days[startDayOfWeek + i] = DateTime(_displayMonth.year, _displayMonth.month, i + 1);
    }
    
    // Add days from the previous month to fill the first week
    if (startDayOfWeek > 0) {
      DateTime previousMonth = DateTime(_displayMonth.year, _displayMonth.month - 1, 0);
    ...
    DateTime nextMonth = DateTime(_displayMonth.year, _displayMonth.month + 1, 1);
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        bool isDisplayMonth = day.month == _displayMonth.month && day.year == _displayMonth.year;
        bool isSelected = widget.selectedDate.day == day.day && 
