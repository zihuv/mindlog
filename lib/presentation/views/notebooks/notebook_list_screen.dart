...
import 'package:mindlog/presentation/views/notebooks/notebook_detail_screen.dart';
...
class NotebookListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final controller = Get.find<NotebookController>();
      ...
      return Scaffold(
        ...
        body: controller.notebooks.isEmpty
            ? Center(
                child: Text(
                ...
                child: ReorderableListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      key: ValueKey(
                        notebook.id,
                      ), // Key required for ReorderableListView
                                ...
                                onPressed: () {
                                  ...
                                  Get.to(
                                    ...
                                    if (value == true) {
                                      ...
                                      NotebookController localController =
                                          Get.find<NotebookController>();
                                      localController.loadNotebooks();
                                    }
                                  });
                                },
                              ),
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            Get.to(() => const NotebookDetailScreen(notebook: null))?.then((
              ...
              if (value == true) {
                // Refresh the notebook list if a notebook was saved
                NotebookController controller = Get.find<NotebookController>();
